...
const REASSURANCE = [
  ...
  // Was "Rolling monthly if you go ahead, no long-term lock-in". Removed
  // 9 Sep 2026 with the rest of the contract claims; see LandingHero. This
  // says something true about the audit rather than about a contract.
