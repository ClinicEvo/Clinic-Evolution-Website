...
import { LP_FORM_ANCHOR_FOOTER, LP_TURNAROUND, type LpVariant } from "@/lib/lp";
 ...
 */
/*
 * "Read by a person, not generated by a tool" came out on 9 Sep 2026: the same
...
export default function LandingAudit({ variant }: { variant: LpVariant }) {
  return (
    // The SECOND form on the page since 9 Sep 2026. The first sits beside the
    // audit pitch and owns the #audit anchor every CTA points at; this one is
    // for the reader who went through the FAQ first.
    <section
      id={LP_FORM_ANCHOR_FOOTER.slice(1)}
      tabIndex={-1}
          ...
          <FadeUp delay={0.08}>
            ...
            <div className="lg:sticky lg:top-28" data-lp-form>
              <div className="card-surface p-6 sm:p-8">
                ...
                <LpAuditForm variant={variant} position="footer" />
              </div>
            </div>
          </FadeUp>
        </div>
