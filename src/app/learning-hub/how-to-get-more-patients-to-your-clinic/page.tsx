...
export const metadata = buildMetadata({
  ...
  path: "/learning-hub/how-to-get-more-patients-to-your-clinic/",
});
...
export default function ArticlePage() {
  ...
  const relatedLinks = [
    { label: "How much should a clinic spend on marketing?", href: "/learning-hub/how-much-should-a-clinic-spend-on-marketing/" },
    { label: "Patient recall system guide", href: "/learning-hub/patient-recall-system/" },
