...
/**
 * The osteopathy Growth System page, at the URL its Google Ads ad group is built
 * around: "[osteopath marketing agency]" is the group's head keyword, so it is the path
 ...
 */
const variant = getGrowthVariant("osteopathy")!;
...
export default function OsteopathMarketingAgencyPage() {
