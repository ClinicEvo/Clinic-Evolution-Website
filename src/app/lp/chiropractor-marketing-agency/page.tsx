...
/**
 * The chiropractic Growth System page, at the URL its Google Ads ad group is built
 * around: "[chiropractor marketing agency]" is the group's head keyword, so it is the path
 ...
 */
const variant = getGrowthVariant("chiropractic")!;
...
export default function ChiropractorMarketingAgencyPage() {
